...
type DebtType = "DEBT" | "PAYMENT" | "ADJUSTMENT";
...
const parseImportDate = (value: unknown): Date => {
  if (
    typeof value === "string" &&
...
const validateAndPrepareItems = async (
  rawItems: unknown
...
const getCurrentSupplierBalance = async (
...
const appendSupplierDebt = async (
  ...
  const currentBalance =
    await getCurrentSupplierBalance(
      tx,
      input.supplier_id
    );
  ...
  const balanceAfter =
    currentBalance.plus(change);

  if (
    balanceAfter.lessThan(0)
  ) {
    throw new Error(
      `Không thể thực hiện vì công nợ nhà cung cấp sẽ bị âm. ` +
      ...
      await prisma.$transaction(
        async (tx) => {
          ...
          for (
            ...
            if (!before) {
              throw new Error(
                `Không tìm thấy biến thể ${item.variant_id}`
              );
            }
            ...
            await createInventoryTransaction(
              tx,
              {
                ...
                note:
                  `IMPORT_RECEIPT:${receipt.id}:${receipt.receipt_code}`,
          ...
          if (
            ...
            await appendSupplierDebt(
              tx,
              {
                ...
                note:
                  `Phát sinh công nợ từ phiếu nhập ${receipt.receipt_code}`,
    ...
    if (
      ...
      return res
        ...
        .json({
          ...
          message:
            "Tổng tiền mới nhỏ hơn số tiền đã thanh toán của phiếu. Hãy cập nhật thanh toán trước.",
        });
    }

    const oldDebtAmount =
      Number(
        oldReceipt.debt_amount ||
          0
      );
        ...
        async (tx) => {
          ...
          for (
            ...
            if (
              ...
              throw new Error(
                `Không thể cập nhật phiếu vì tồn kho SKU ID ${variantId} không đủ để hoàn lại số lượng cũ.`
              );
            }
            ...
            if (
              ...
              await createInventoryTransaction(
                tx,
                {
                  ...
                  note:
                    `Điều chỉnh phiếu nhập ${oldReceipt.receipt_code}`,
                }
              );
            } else if (
              newItem
            ...
            if (
              ...
              await appendSupplierDebt(
                tx,
                {
                  ...
                  reference_code:
                    oldReceipt.receipt_code,

                  note:
                    `Điều chỉnh công nợ do sửa phiếu nhập ${oldReceipt.receipt_code}`,
                }
              );
            }
          } else {
            ...
            if (
              ...
              await appendSupplierDebt(
                tx,
                {
                  ...
                  note:
                    `Hoàn công nợ do đổi nhà cung cấp của phiếu ${oldReceipt.receipt_code}`,
                }
              );
            }
            ...
            if (
              ...
              await appendSupplierDebt(
                tx,
                {
                  ...
                  note:
                    `Phát sinh công nợ sau khi sửa phiếu nhập ${oldReceipt.receipt_code}`,
                }
              );
            }
          }
...
export const updateImportPayment = async (
  req: Request,
  res: Response
) => {
  try {
    ...
    if (
      ...
      return res
        ...
        .json({
          success: false,
          message:
            "Số tiền thanh toán không được lớn hơn tổng tiền phiếu nhập",
        });
    }
            ...
            if (
              ...
              await appendSupplierDebt(
                tx,
                {
                  ...
                  note:
                    `Điều chỉnh công nợ theo thanh toán phiếu ${receipt.receipt_code}`,
                }
              );
            }
          }
    ...
    return res
      ...
      .json({
        ...
        message:
          "Cập nhật thanh toán và công nợ thành công",
  ...
  try {
      ...
      async (tx) => {
        for (
          ...
          if (
            ...
            throw new Error(
              `Không thể xóa phiếu ${receipt.receipt_code} vì tồn hiện tại của một sản phẩm thấp hơn số lượng đã nhập từ phiếu.`
            );
          }
          ...
          await createInventoryTransaction(
            tx,
            {
              ...
              note:
                `Xóa phiếu nhập ${receipt.receipt_code}`,
            }
          );
        }
        ...
        if (
          ...
          await appendSupplierDebt(
            tx,
            {
              ...
              note:
                `Hoàn công nợ do xóa phiếu nhập ${receipt.receipt_code}`,
            }
          );
        }
    ...
    return res
      ...
      .json({
        ...
        message:
          "Xóa phiếu nhập thành công, đã hoàn tồn và cập nhật công nợ",
      });
  } catch (error) {
    console.error(
      "Lỗi xóa phiếu nhập:",
